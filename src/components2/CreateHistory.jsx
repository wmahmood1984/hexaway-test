...
export default function CreateHistory() {
    ...
    const [filter, setFilter] = useState("NFT Creation")
            ...
            <div id="history-page" class="page">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
                        <div>
                            <h2 class="text-3xl font-bold text-gray-900 mb-2">Creation History</h2>
                            <p class="text-gray-600">View all your creations</p>
                        </div>
                                ...
                                <div class="transaction-card bg-white rounded-xl shadow-lg p-6 border border-gray-100" data-type="nft-trade">
                                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                                        ...
                                        <div class="text-right">
                                            {(v.eventType== "Trade"
                                            && v.values._type!="0") ||v.eventType== "Upgrades" ?
